...
<a href="https://living-atlases.gbif.org/">
    <img src="{{ 'fig/livingatlas.PNG' | relative_url }}" alt="LA" width="550">{: .image-with-shadow }
</a>
...
<img src="{{ 'fig/laslack.PNG' | relative_url }}" alt="LA" width="550">{: .image-with-shadow }
...
<a href="https://www.gbif.org/programme/82219/capacity-enhancement-support-programme">
    <img src="{{ 'fig/cesp.PNG' | relative_url }}" alt="cesp" width="550">{: .image-with-shadow }
</a>
...
<img src="{{ 'fig/croment.PNG' | relative_url }}" alt="croment" width="550">{: .image-with-shadow }

<img src="{{ 'fig/cespfunded.PNG' | relative_url }}" alt="funded" width="550">{: .image-with-shadow }
...
<a href="https://www.gbif.org/programme/82243/bid-biodiversity-information-for-development">
    <img src="{{ 'fig/bid.PNG' | relative_url }}" alt="BID" width="600">{: .image-with-shadow }
</a>
...
<img src="{{ 'fig/bid2.PNG' | relative_url }}" alt="bid" width="550">{: .image-with-shadow }

# Data use club

<a href="https://www.gbif.org/data-use-club">
    <img src="{{ 'fig/datauseclub.PNG' | relative_url }}" alt="Data Use club" width="600">{: .image-with-shadow }
</a>
...
<a href="https://www.survey-xact.dk/LinkCollector?key=CM9WQF59S11K">
    <img src="{{ 'fig/datacamp.PNG' | relative_url }}" alt="datacamp" width="600">{: .image-with-shadow }
</a>
...
<a href="https://www.gbif.org/ambassadors">
    <img src="{{ 'fig/ambassadors.PNG' | relative_url }}" alt="ambassadors" width="600">{: .image-with-shadow }
</a>
...
<a href="https://www.gbif.org/translators">
    <img src="{{ 'fig/translators.PNG' | relative_url }}" alt="translators" width="600">{: .image-with-shadow }
</a>
...
<a href="https://www.gbif.org/ebbe">
    <img src="{{ 'fig/ebbe.PNG' | relative_url }}" alt="ebbe" width="600">{: .image-with-shadow }
</a>
...
<a href="https://gbif-alert-demo.thebinaryforest.net/">
    <img src="{{ 'fig/ebbewinner.PNG' | relative_url }}" alt="ebbewinner" width="600">{: .image-with-shadow }
</a>
...
<a href="https://www.gbif.org/graduate-researchers-award">
    <img src="{{ 'fig/award.PNG' | relative_url }}" alt="Graduate Researchers Award" width="600">{: .image-with-shadow }
</a>
...
<a href="https://www.gbif.org/data-use">
    <img src="{{ 'fig/datause.PNG' | relative_url }}" alt="Data use" width="600">{: .image-with-shadow }
</a>
...
<a href="https://www.gbif.org/mentors">
    <img src="{{ 'fig/mentors.PNG' | relative_url }}" alt="Mentors" width="600">{: .image-with-shadow }
</a>
